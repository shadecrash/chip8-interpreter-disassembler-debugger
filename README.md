...
## Running Locally
1. You'll need any simple HTTP webserver of your choice
    - `python3 -m http.server` should do the trick
    - [Alternative application](https://www.npmjs.com/package/local-web-server)
